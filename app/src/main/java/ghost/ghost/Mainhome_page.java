 ...
 */
public class Mainhome_page extends FragmentActivity implements View.OnClickListener {
   // private ImageView titleLeftImv;
   // private TextView titleTv;
   // 定义4个Fragment对象
   private Main_page fg1;
    private Mainhome_advertisement fg2;
    private Mainhome_video fg3;
    private Mainhome_mineup fg4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mainhome_page);
        ...
        if (savedInstanceState == null) {
                       getSupportFragmentManager()
                               .beginTransaction()
                               .add(R.id.container, new Main_page())
                               .commit();
                  }
...
// 初始化底部导航栏的控件
        ...
        firstLayout.setOnClickListener(Mainhome_page.this);
        secondLayout.setOnClickListener(Mainhome_page.this);
        thirdLayout.setOnClickListener(Mainhome_page.this);
        fourthLayout.setOnClickListener(Mainhome_page.this);
...
// secondImage.setImageResource(R.drawable.XXXX);
                ...
                if (fg2 == null) {
                    fg2 = new Mainhome_advertisement();
...
// fourthImage.setImageResource(R.drawable.XXX);
   ...
   /* public void skip(){
        Button button2=(Button) findViewById(R.id.bt_more2);
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(),Mainhome_advertisement.class);
